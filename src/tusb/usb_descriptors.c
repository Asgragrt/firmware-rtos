...
uint8_t const desc_configuration[] = {
    ...
    TUD_HID_DESCRIPTOR(ITF_NUM_HID_KBD, 4, HID_ITF_PROTOCOL_NONE, sizeof(desc_hid_report_kbd), EPNUM_HID_KBD, CFG_TUD_HID_EP_BUFSIZE, POLLING_INTERVAL),
    TUD_HID_INOUT_DESCRIPTOR(ITF_NUM_HID_INOUT, 5, HID_ITF_PROTOCOL_NONE, sizeof(desc_hid_report_inout), EPNUM_HID_INOUT, 0x80 | EPNUM_HID_INOUT, CFG_TUD_HID_EP_BUFSIZE, POLLING_INTERVAL),
};
...
uint16_t const* tud_descriptor_string_cb(uint8_t index, uint16_t langid){
    ...
    default:
        ...
        uint8_t const max_count = sizeof(_desc_str) / sizeof(_desc_str[0]) - 1;
